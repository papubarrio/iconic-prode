  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ ...S.tabBar, marginBottom: 0 }}>
        <button style={S.tab(sortMode === "group")} onClick={() => setSortMode("group")}>By Group</button>
        <button style={S.tab(sortMode === "chrono")} onClick={() => setSortMode("chrono")}>Chronological</button>
      </div>
      ...
      {sortMode === "group" ? (
        ...
        <div style={S.card}>
          <div style={S.cardHeader}>
            <span style={S.cardHeaderTitle}>All Matches</span>
            <span style={{ marginLeft: "auto", fontSize: 13, color: "rgba(255,255,255,0.65)", fontWeight: 500 }}>
              {chronological.filter(m => !isLocked(m)).length} open
            </span>
          </div>
